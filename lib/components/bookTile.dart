          ...
          return await showDialog(
              ...
              builder: (BuildContext context) {
                return AlertDialog(
                  ...
                  content: Text(
                    "Tem certeza que quer excluir o livro ${book.title}",
                ...
                children: [
                  Container(
                    ...
                    FutureBuilder<String>(
                        future: DatabaseService(uid: uid).getFileURL(book.cover),
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                !book.isRead
                                    ? Text('Avaliação não disponível',
                                  style: TextStyle(fontStyle: FontStyle.italic, fontSize: 13.0, color: Colors.white70),
                                )
                                    : RatingBar.builder(
                                  initialRating: book.rate?.toDouble() ?? 0.0,
                                  ignoreGestures: true,
                                  minRating: 1,
                                  maxRating: 5,
                                  itemCount: 5,
                                ...
                                DecoratedBox(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Text('Finalizado', style: TextStyle(fontSize: 12.0),),
                                  ),
                                ) : Container()
                              ],
                            ),
